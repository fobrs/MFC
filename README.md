...
In previous versions of Visual Studio the bundled MFC source files could be compiled into a static library or a DLL. But since Visual Studio 2008 the necessary files to build MFC are not supplied anymore. In this article I show you how you can compile the MFC sources with Visual Studio 2022. The latest changes support <b>ARM64</b> and <b>Managed Winforms controls</b> (thanks to the sponsoring by the kind software consultant from the Bahamas).
# Introduction
