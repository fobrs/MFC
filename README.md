...
The latest version has an Active X Contol added to test passing floats and doubles on <b>ARM64</b>. Open the Aboutbox and click DATE, then click in the circle. The circ.dll file has to be registered in an admin console with <b>regsrv32 circ.dll</b>.
